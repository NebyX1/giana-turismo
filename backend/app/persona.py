...
def persona_answer(query: str) -> str:
    ...
    if any(x in q for x in ("quién sos", "quien sos", "qué sos", "que sos", "cómo te llamás", "como te llamas")):
        return "Soy Gianna, la asistente turística de Lavalleja. Estoy acá para ayudarte a descubrir lugares, actividades, gastronomía, alojamiento y mucho más."
    ...
    return "Soy Gianna, una asistente turística conversacional de Lavalleja. Puedo ayudarte a descubrir lugares, actividades, gastronomía, alojamiento y experiencias del departamento."
